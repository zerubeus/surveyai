...
import {
  ...
  pValueColor,
  effectSizeMagnitude,
} from "@/components/workflow/ResultChart";
...
/* ------------------------------------------------------------------ */
/*  Helpers (shared helpers imported from ResultChart.tsx)              */
/* ------------------------------------------------------------------ */
...
/* ContingencyTable and ResultChart imported from @/components/workflow/ResultChart */
